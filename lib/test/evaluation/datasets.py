...
dataset_dict = dict(
    ...
    uav=DatasetInfo(module=pt % "uav123", class_name="UAVDataset", kwargs=dict()),
    ...
    uav123_l=DatasetInfo(module=pt % "uav123_l", class_name="UAV123Dataset", kwargs=dict()),
    ...
    uavtrack112_l=DatasetInfo(module=pt % "uavtrack112_l", class_name="UAVTrack112Dataset", kwargs=dict()),
    ...
    dtb=DatasetInfo(module=pt % "dtb", class_name="DTBDataset", kwargs=dict()),
