...
import lib.test.vot_rgb.vot as vot
from lib.test.vot_rgb.vot_utils import *
...
class SUTrack(object):
    def __init__(self, tracker_name='sutrack', para_name='sutrack_b224'):
        # create tracker
        tracker_info = Tracker(tracker_name, para_name, "vot", None)
...
def run_vot_exp(tracker_name, para_name, vis=False):
    ...
    save_root = os.path.join('/home/cx/cx1/MSRA/CLOUD/MyExperiments/SeqTrack/external/vot20/vis', para_name)
