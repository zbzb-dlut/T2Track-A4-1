...
from lib.models.uavtrack import starnet as starnet_module
import torch


class EncoderBase(nn.Module):

    def __init__(self, encoder: nn.Module, train_encoder: bool, open_layers: list, num_channels: int,mlp_dim:int):
        super().__init__()
    ...
    def __init__(self, name: str,
        ...
        if "fastitpn" in name.lower():
            ...
            if "itpnb" in name:
                ...
                num_channels = 512
        elif "starnet" in name.lower():
            encoder = getattr(starnet_module, name)(
            ...
            raise ValueError()
        super().__init__(encoder, train_encoder, open_layers, num_channels,mlp_dim)
